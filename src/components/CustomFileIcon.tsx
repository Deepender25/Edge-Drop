  ...
  if (kind === 'image') {
    return (
      <svg {...svgProps}>
        <defs>
          <filter id={glyphShadowId} x="-20%" y="-20%" width="140%" height="140%">
            <feDropShadow dx="0" dy="4" stdDeviation="5" floodColor="#9D174D" floodOpacity="0.22" />
            <feDropShadow dx="0" dy="1" stdDeviation="2" floodColor="#000000" floodOpacity="0.05" />
          </filter>
          <filter id={folderShadowId} x="-10%" y="-10%" width="120%" height="120%">
            <feDropShadow dx="0" dy="10" stdDeviation="16" floodColor="#BE185D" floodOpacity="0.12" />
          </filter>
        </defs>
        <g filter={`url(#${folderShadowId})`}>
          <path d="M 56 378 L 56 128 C 56 112 68 100 84 100 L 162 100 C 178 100 190 108 200 120 C 208 130 218 136 232 136 L 428 136 C 444 136 456 148 456 164 L 456 378 C 456 396 442 410 424 410 L 88 410 C 70 410 56 396 56 378 Z" fill="#F9A8D4" />
          <path d="M 74 162 L 74 152 C 74 147 78 143 83 143 L 429 143 C 434 143 438 147 438 152 L 438 162 Z" fill="#FFF1F8" />
          <path d="M 56 168 C 56 156 65 148 76 148 L 436 148 C 447 148 456 156 456 168 L 456 378 C 456 396 442 410 424 410 L 88 410 C 70 410 56 396 56 378 Z" fill="#F472B6" />
          <g filter={`url(#${glyphShadowId})`}>
  ...
  if (kind === 'text') {
    return (
      <svg {...svgProps}>
        ...
        <g filter={`url(#${folderShadowId})`}>
          <path d="M 56 378 L 56 128 C 56 112 68 100 84 100 L 162 100 C 178 100 190 108 200 120 C 208 130 218 136 232 136 L 428 136 C 444 136 456 148 456 164 L 456 378 C 456 396 442 410 424 410 L 88 410 C 70 410 56 396 56 378 Z" fill="#D1DBE5" />
          <path d="M 74 162 L 74 152 C 74 147 78 143 83 143 L 429 143 C 434 143 438 147 438 152 L 438 162 Z" fill="#F8FAFC" />
          <path d="M 56 168 C 56 156 65 148 76 148 L 436 148 C 447 148 456 156 456 168 L 456 378 C 456 396 442 410 424 410 L 88 410 C 70 410 56 396 56 378 Z" fill="#B2C0D0" />
          <g filter={`url(#${sheetShadowId})`}>
            ...
            <path d="M 281 201 L 281 232 C 281 238 286 243 292 243 L 323 243" fill="none" stroke="#B2C0D0" strokeWidth="7" strokeLinecap="round" strokeLinejoin="round" />
            <line x1="210" y1="268" x2="256" y2="268" stroke="#B2C0D0" strokeWidth="7" strokeLinecap="round" />
            <line x1="210" y1="294" x2="300" y2="294" stroke="#B2C0D0" strokeWidth="7" strokeLinecap="round" />
            <line x1="210" y1="320" x2="300" y2="320" stroke="#B2C0D0" strokeWidth="7" strokeLinecap="round" />
            <line x1="210" y1="346" x2="276" y2="346" stroke="#B2C0D0" strokeWidth="7" strokeLinecap="round" />
          </g>
        </g>
      </svg>
    )
    ...
    return (
      <svg {...svgProps}>
        <defs>
          ...
          <filter id={folderShadowId} x="-10%" y="-10%" width="120%" height="120%">
            <feDropShadow dx="0" dy="10" stdDeviation="16" floodColor="#BE123C" floodOpacity="0.12" />
          </filter>
        </defs>
        <g filter={`url(#${folderShadowId})`}>
          <path d="M 56 378 L 56 128 C 56 112 68 100 84 100 L 162 100 C 178 100 190 108 200 120 C 208 130 218 136 232 136 L 428 136 C 444 136 456 148 456 164 L 456 378 C 456 396 442 410 424 410 L 88 410 C 70 410 56 396 56 378 Z" fill="#FFA1AD" />
          <path d="M 74 162 L 74 152 C 74 147 78 143 83 143 L 429 143 C 434 143 438 147 438 152 L 438 162 Z" fill="#FFF0F3" />
          <path d="M 56 168 C 56 156 65 148 76 148 L 436 148 C 447 148 456 156 456 168 L 456 378 C 456 396 442 410 424 410 L 88 410 C 70 410 56 396 56 378 Z" fill="#FF6E7F" />
          <g filter={`url(#${sheetShadowId})`}>
            <rect x="176" y="224" width="160" height="128" rx="20" fill="#FFF0F3" />
            <rect x="192" y="240" width="16" height="16" rx="4" fill="#FF6E7F" />
            <rect x="192" y="266.67" width="16" height="16" rx="4" fill="#FF6E7F" />
            <rect x="192" y="293.33" width="16" height="16" rx="4" fill="#FF6E7F" />
            <rect x="192" y="320" width="16" height="16" rx="4" fill="#FF6E7F" />
            <rect x="216" y="240" width="80" height="96" rx="8" fill="#FF6E7F" />
            <rect x="304" y="240" width="16" height="16" rx="4" fill="#FF6E7F" />
            <rect x="304" y="266.67" width="16" height="16" rx="4" fill="#FF6E7F" />
            <rect x="304" y="293.33" width="16" height="16" rx="4" fill="#FF6E7F" />
            <rect x="304" y="320" width="16" height="16" rx="4" fill="#FF6E7F" />
